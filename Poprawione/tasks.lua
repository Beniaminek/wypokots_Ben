--npc tasks config
config = {
    [1] = {name = "Apes", killsRequired  = 300, creatures = {"kongra", "sibang", "merlkin"}, exp = 36000, money = 5000, tibiaCoins = 2}, --"Gorila"
    [2] = {name = "Carniphilas", killsRequired  = 300, creatures = {"carniphila"}, exp = 45000, money = 8000, tibiaCoins = 2}, --"Deathbine"
    [3] = {name = "Crocodiles", killsRequired  = 200, creatures = {"crocodile"}, exp = 12000, money = 2000, tibiaCoins = 1}, --"The Snapper"
    [4] = {name = "Cyclops", killsRequired  = 400, creatures = {"cyclops", "cyclops drone", "cyclops smith"}, exp = 80000, money = 4000, tibiaCoins = 2}, --"The Old Whopper"
    [5] = {name = "Gargoyles", killsRequired  = 200, creatures = {"gargoyle"}, exp = 24500, money = 0, tibiaCoins = 1}, --"Stoner"
    [6] = {name = "Mammoths", killsRequired  = 200, creatures = {"mammoth"}, exp = 24000, money = 5000, tibiaCoins = 2}, --"The Bloodtusk"
    [7] = {name = "Minotaurs", killsRequired  = 500, creatures = {"minotaur", "minotaur mage", "minotaur archer", "minotaur guard"}, exp = 10200, money = 7500, tibiaCoins = 2},
    [8] = {name = "Minotaurs", killsRequired  = 3000, creatures = {"minotaur", "minotaur mage", "minotaur archer", "minotaur guard"}, exp = 330000, money = 5000, tibiaCoins = 6}, --"The Horned Fox"
    [9] = {name = "Mutated Humans", killsRequired  = 300, creatures = {"mutated human"}, exp = 42750, money = 0, tibiaCoins = 2}, --"Mutanted"
    [10] = {name = "Orcs", killsRequired  = 300, creatures = {"orc", "orc berserker", "orc leader", "orc rider", "orc shaman", "orc spearman", "orc warlord", "orc warrior"}, exp = 42000, money = 5000, tibiaCoins = 2}, --"Bibby Bloodbath" 
    ...
    [20] = {name = "Giant Spiders", killsRequired  = 500, creatures = {"giant spider"}, exp = 337500, money = 10000, tibiaCoins = 3}, --"The Old Widow"
    [21] = {name = "Ice Golems", killsRequired  = 300, creatures = {"ice golem"}, exp = 88500, money = 4000, tibiaCoins = 2}, --"Shardhead"
    [22] = {name = "Lancer Beetles", killsRequired  = 300, creatures = {"lancer beetle"}, exp = 72188, money = 0, tibiaCoins = 2}, --"Deadly Beetle"
    [23] = {name = "Mutated Bats", killsRequired  = 350, creatures = {"mutated bat"}, exp = 184500, money = 10000, tibiaCoins = 3}, --"Bruise Payne"
    [24] = {name = "Mutated Rats", killsRequired  = 400, creatures = {"mutated rat"}, exp = 135000, money = 5000, tibiaCoins = 2}, --"Esmeralda"
    [25] = {name = "Mutated Tigers", killsRequired  = 400, creatures = {"mutated tiger"}, exp = 262500, money = 0, tibiaCoins = 3}, --"Tigre"
...
bosses = {
	[10011] = {bossName = 'White Pale', bossPosition = Position(5983, 1506, 9), centerPosition = Position(5979, 1513, 9), rangeX = 12, rangeY = 12},
	[10003] = {bossName = 'The Snapper', bossPosition = Position(6885, 662, 10), centerPosition = Position(6882, 666, 10), rangeX = 12, rangeY = 12},
	[10013] = {bossName = 'Hide', bossPosition = Position(6833, 748, 10), centerPosition = Position(6830, 749, 10), rangeX = 12, rangeY = 12},
	[10002] = {bossName = 'Deathbine', bossPosition = Position(6769, 535, 8), centerPosition = Position(6766, 541, 8), rangeX = 12, rangeY = 12},
	[10021] = {bossName = 'Shardhead', bossPosition = Position(6484, 1784, 8), centerPosition = Position(6482, 1792, 8), rangeX = 12, rangeY = 12},
	[10024] = {bossName = 'Esmeralda', bossPosition = Position(6187, 1011, 9), centerPosition = Position(6189, 1006, 9), rangeX = 12, rangeY = 12},
	[10019] = {bossName = 'The Bloodweb', bossPosition = Position(6544, 1805, 8), centerPosition = Position(6547, 1809, 8), rangeX = 12, rangeY = 12},
	...
	[10004] = {bossName = 'The Old Whopper', bossPosition = Position(5865, 1478, 9), centerPosition = Position(5870, 1480, 9), rangeX = 9, rangeY = 9},
